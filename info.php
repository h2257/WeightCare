      ...
      <div data-role="collapsible-set">
        <div data-role="collapsible" data-content-theme="b" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
			<h3>孕乳婦飲食一般飲食原則</h3>
				...
				<p>
						<img src="form1.jpg" height="auto" width="100%">
				</p>
				<p>
					3.熱量:
				</p>
	...
	<div data-role="content">
      <div data-role="collapsible-set">
			<div data-role="collapsible" data-content-theme="b" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
				<h3>運動注意事項</h3>
					<p>
					<img src="notice.jpg" height="auto" width="100%">
					</p>
			</div>
			<div data-role="collapsible" data-content-theme="b" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
				<h3>腿部運動(早期開始做)</h3>
					<p>
					<img src="before1.jpg" height="auto" width="100%">
					</p>
			</div>
			<div data-role="collapsible" data-content-theme="b" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
				<h3>腳部運動(早期開始做)</h3>
					<p>
					<img src="before2.jpg" height="auto" width="100%">
					</p>
			</div>
			<div data-role="collapsible" data-content-theme="b" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
				<h3>盤腳坐式(三個月後)</h3>
					<p>
					<img src="3months.jpg" height="auto" width="100%">
					</p>
			</div>
			<div data-role="collapsible" data-content-theme="b" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
				<h3>腰部運動(六個月後)</h3>
					<p>
					<img src="6months.jpg" height="auto" width="100%">
					</p>
			</div>
			<div data-role="collapsible" data-content-theme="b" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
				<h3>腰部深呼吸(懷孕末期)</h3>
					<p>
					<img src="final1.jpg" height="auto" width="100%">
					</p>
			</div>
			<div data-role="collapsible" data-content-theme="b" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
				<h3>胸式呼吸(懷孕末期)</h3>
					<p>
					<img src="final2.jpg" height="auto" width="100%">
					</p>
			</div>
    </div>
  </div>
